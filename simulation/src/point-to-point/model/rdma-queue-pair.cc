...
namespace ns3
{
	...
	/*******************************************************************************
	 * This is the constructor for the RdmaQueuePair class. It initializes various
	 * member variables based on the provided parameters.
	 *******************************************************************************/
	...
	/******************************************************
	 * This function calculates a hash value based on the
	...
	/******************************************************
	 * This function is used to acknowledge received
	 * packets and update the snd_una variable.
	 *****************************************************/
	 ...
	 * of bytes on the fly (sent but not yet acknowledged).
	 *****************************************************/
	...
	/******************************************************
	 * This function checks if the current transmission
	 * is window-bound based on the window size.
	 *****************************************************/
	...
	/******************************************************
	 * This function calculates and returns the effective
	 * window size based on the configured window size and
	 * rate parameters.
	 *****************************************************/
	...
	/*******************************************************
	 * This function checks if the transmission is finished
	 * based on the acknowledgment of all sent data.
	 ******************************************************/
